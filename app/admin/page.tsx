  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Welcome to the Moopa admin dashboard.</p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <Card className="col-span-4">
          ...
          <CardContent className="h-[300px] flex items-center justify-center border-t p-6">
            <div className="text-center text-muted-foreground">Chart visualization would go here</div>
          </CardContent>
        </Card>
